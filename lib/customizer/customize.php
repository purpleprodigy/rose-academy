 ...
 * Rose Academy.
 *
 * This file adds the Customizer additions to the Rose Academy Theme.
 *
 * @package Academy
 * @author  StudioPress
 * @license GPL-2.0+
...
function academy_customizer_register( $wp_customize ) {
	...
	$wp_customize->add_panel(
		'academy-settings', array(
			'description' => __( 'Set up the Rose Academy settings and defaults.', 'academy-pro' ),
			'priority'    => 80,
			'title'       => __( 'Rose Academy Settings', 'academy-pro' ),
		)
	);
	...
	$wp_customize->add_section(
		'academy-basic-settings', array(
			'description' => sprintf( '<strong>%s</strong>', __( 'Modify the Rose Academy Theme basic settings.', 'academy-pro' ) ),
